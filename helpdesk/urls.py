...
urlpatterns = [
    ...
    url(r'^issue/(?P<issue_id>[0-9]+)/edit/$', views.issue_edit,
        name='issue_edit'),
    url(r'^issue/(?P<issue_id>[0-9]+)/comment/$', views.comment_create,
        name='comment_create'),
    ...
    url(r'^kb/(?P<article_id>[0-9]+)/$', views.article_show,
        name='article_show'),
    url(r'^kb/(?P<article_id>[0-9]+)/edit/$', views.article_edit,
        name='article_edit'),
    url(r'^kb/topic/(?P<topic>(.*)+)/$', views.article_topic,
        name='article_topic'),
]
